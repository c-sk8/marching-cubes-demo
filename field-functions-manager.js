...
},
{
	...
	currentVariant: 0,
	variants: [
		{ params: [20, 20, 1], bounds: [0,1,0.43,0.536,0,1] },
		{ params: [14, 14, 1], bounds: [0,1,0.39,0.55,0,1] },
		{ params: [14, 10, 2], bounds: [0,1,0.442,0.555,0,1] },
		{ params: [14, 18, 4], bounds: [0,1,0.47,0.53,0,1] }
	]
},
{
	name: "Blob Ring",
...
},
{
	...
	currentVariant: 0,
	variants: [
		{ params: [20, 14, 2], bounds: [0,1,0.48,0.52,0,1] },
		{ params: [18, 14, 2], bounds: [0,1,0.48,0.52,0,1] },
		{ params: [16, 14, 2], bounds: [0,1,0.48,0.52,0,1] },
		{ params: [14, 14, 2], bounds: [0,1,0.48,0.52,0,1] },
		{ params: [12, 14, 2], bounds: [0,1,0.48,0.52,0,1] },
		{ params: [10, 14, 2], bounds: [0,1,0.48,0.52,0,1] },
		{ params:  [8, 14, 2], bounds: [0,1,0.48,0.52,0,1] }
	]
},
{
	...
	currentVariant: 6,
	variants: [
		{ params: [3.1, 1, 2.2, 3.6], bounds: [0.0229,0.9771,0.0229,0.9771,0.0229,0.9771] },
		{ params: [3.1, 1, 2.2, 3.1], bounds: [0.0250,0.9750,0.0250,0.9750,0.0250,0.9750] },
		{ params: [3.1, 1, 2.2, 2.6], bounds: [0.0277,0.9723,0.0277,0.9723,0.0277,0.9723] },
		{ params: [3.1, 1, 2.2, 2.1], bounds: [0.0305,0.9695,0.0305,0.9695,0.0305,0.9695] },
		{ params: [3.1, 1, 2.2, 1.6], bounds: [0.0341,0.9659,0.0341,0.9659,0.0341,0.9659] },
		{ params: [3.1, 1, 2.2, 1.1], bounds: [0.0387,0.9613,0.0387,0.9613,0.0387,0.9613] },
		{ params: [3.1, 1, 2.2, 0.6], bounds: [0.0453,0.9547,0.0453,0.9547,0.0453,0.9547] },
		{ params: [3.1, 1, 2.2, 0.1], bounds: [0.0555,0.9445,0.0555,0.9445,0.0555,0.9445] }
	]
},
{
	...
	currentVariant: 0,
	variants: [
		{ params: [1.45, 1, 1.5], bounds: [0.0197,0.9803,0.0197,0.9803,0.0197,0.9803] },
		{ params: [0.7, 1, 2.5], bounds: [0.1025,0.8975,0.1025,0.8975,0.1025,0.8975] },
		{ params: [1.2, 1, 0.9], bounds: [0.0557,0.9443,0.0557,0.9443,0.0557,0.9443] }
	]
},
{
	name: "Gyroid Floor",
	...
	currentVariant: 3,
	variants: [
		{ params: [3, 2.5, 1.5], bounds: [0.0290,0.9900,0.0037,0.7816,0.0061,0.9914] },
		{ params: [4, 2.5, 1.5], bounds: [0.0032,0.9681,0.0015,0.7818,0.0081,0.9971] },
		{ params: [5, 2.5, 1.5], bounds: [0.0051,0.9442,0.0007,0.7819,0.0062,0.9978] },
		{ params: [6, 2.5, 1.5], bounds: [0.0039,0.9773,0.0004,0.7816,0.0065,0.9945] },
...
},
{
	...
	currentVariant: 2,
	variants: [
		{ params: [7, 5], bounds: [0.0000,1.0000,0.2000,0.6261,0.0000,1.0000] },
		{ params: [10, 15], bounds: [0.0000,1.0000,0.4000,0.5488,0.0000,1.0000] },
		{ params: [12, 16], bounds: [0.0000,1.0000,0.4063,0.5458,0.0000,1.0000] },
		{ params: [15, 17], bounds: [0.0000,1.0000,0.4118,0.5431,0.0000,1.0000] },
		{ params: [20, 20], bounds: [0.0000,1.0000,0.4250,0.5365,0.0000,1.0000] }
	]
},
{
	name: "Blob Ring",
